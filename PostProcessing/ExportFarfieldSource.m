function ExportFarfieldSource(mws,exportpath, frequency)
...
SelectTreeItem = invoke(mws,'SelectTreeItem',char(strcat('Farfields\Farfield',num2str(frequency),strcat({' '}, '[1]')))); 
