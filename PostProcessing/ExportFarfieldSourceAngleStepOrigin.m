function ExportFarfieldSourceAngleStepOrigin(mws,exportpath, frequency,port,StepTheta,StepPhi,Origin,Position)
...
if isequal(Origin,'bbox')
invoke(FarfieldPlot,'Origin','bbox');
invoke(FarfieldPlot,'Userorigin','0.000000e+000','0.000000e+000','0.000000e+000');
end
if isequal(Origin,'free')
invoke(FarfieldPlot,'Origin','free');
invoke(FarfieldPlot,'Userorigin',num2str(Position(1)),num2str(Position(2)),num2str(Position(3)));  
end  
